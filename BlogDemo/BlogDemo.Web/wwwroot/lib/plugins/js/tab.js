    ...
    var _tab = {
        ...
        createTabDom: function() {
            ...
            var tpl = [
                    ...
                    '<li class="layui-this" lay-id="-1" data-url="' + _config.mainUrl + '"><i class="layui-icon">&#xe68e;</i> 欢迎页</li>',
                    '</ul>',
                    '<div class="kit-tab-tool">选项卡&nbsp;<i class="fa fa-caret-down"></i></div>',
            ...
            var _tool = $('.kit-tab-tool'),
                ...
                _toolTitle = $('.layui-tab-title');

            //监听操作点击事件
            //_tool.on('click', function () {
            //    _tool.html('操作&nbsp;<i class="fa fa-caret-down"></i>');
            //    _toolBody.hide();
            //});
            _tool.on('mouseenter', function () {
                _tool.html('选项卡&nbsp;<i class="fa fa-caret-up"></i>');
                _toolBody.show();
            });
            _toolTitle.on('mouseenter', function () {
                _tool.html('选项卡&nbsp;<i class="fa fa-caret-down"></i>');
                _toolBody.hide();
            });
        ...
        winResize: function() {
            ...
            _win.on('resize', function() {
                ...
                switch (_config.renderType) {
                    case renderType.page:
                        $('.kit-tab .layui-tab-content').height(currBoxHeight - 42);
                        break;
                    case renderType.iframe:
